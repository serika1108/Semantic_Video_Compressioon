...
from src.entropy_models.entropy_models import EntropyBottleneck, GaussianConditional
from src.layers.layers import GDN, MaskedConv2d

from src.models.utils import conv, deconv, update_registered_buffers
...
class ScaleHyperprior(CompressionModel):
    ...
    def encode(self, x, output_path):
        from src.models.stream_helper import encode_i
        N, C, H, W = x.size()
    ...
    def decode(self, input_path):
        from src.models.stream_helper import decode_i, get_downsampled_shape
